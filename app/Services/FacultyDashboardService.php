...
class FacultyDashboardService
{
    ...
    public function dataFor(User $user): array
    {
        ...
        if ($participant) {
            ...
            // ⚡ Bolt: Optimize loop aggregation.
            // Replaced O(N*3) loop where(...)->count() with a single pass countBy() aggregation
            // to eliminate redundant collection allocations and improve dashboard load time.
