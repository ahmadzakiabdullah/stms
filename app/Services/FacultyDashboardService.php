...
class FacultyDashboardService
{
    ...
    public function dataFor(User $user): array
    {
        ...
        if ($participant) {
            ...
            // ⚡ Bolt: Replace multiple filtered count() passes with a single countBy() pass.
            // This flattens all squad members from all registrations and counts them by role in a single pass
            // rather than iterating over registrations and filtering each collection multiple times.
