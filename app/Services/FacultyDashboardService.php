...
class FacultyDashboardService
{
    ...
    public function dataFor(User $user): array
    {
        ...
        if ($participant) {
            ...
            // ⚡ Bolt: Optimize squad member aggregation
            // By flattening the nested squad members and using a single countBy() pass,
            // we avoid iterating over multiple collection filters per registration.
