...
class FacultyDashboardService
{
    ...
    public function dataFor(User $user): array
    {
        ...
        if ($participant) {
            ...
            // ⚡ Bolt: Use countBy on all squad members in a single pass instead of filtering inside a loop.
            // This reduces O(n*m) iteration to O(n), significantly speeding up aggregation on large registration sets.
