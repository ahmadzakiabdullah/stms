...
class FacultyDashboardService
{
    ...
    public function dataFor(User $user): array
    {
        ...
        if ($participant) {
            ...
            // Optimize aggregation: use a single countBy pass instead of multiple where()->count() calls per registration
            ...
            $totalOfficials = collect($counts->only(['assistant_manager', 'manager', 'coach', 'physio']))->sum();
        }
