...
class FacultyDashboardService
{
    ...
    public function dataFor(User $user): array
    {
        ...
        if ($participant) {
            ...
            // ⚡ Bolt Performance Optimization: Replace N loop iterations and 3xN collection creations
            // with a single flatMap and countBy pass to drastically reduce memory allocations and CPU cycles.
