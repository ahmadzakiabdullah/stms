...
class FacultyDashboardService
{
    ...
    public function dataFor(User $user): array
    {
        ...
        if ($participant) {
            ...
            // ⚡ Bolt: Optimize aggregation by flattening the collections and grouping in a single pass
            // rather than repeatedly scanning the arrays within a loop using ->where()->count().
