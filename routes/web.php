...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/matches/{match}/live', [MatchShowController::class, 'show'])->name('matches.live');
    ...
    Route::get('/reports/advanced', [AdvancedReportController::class, 'index'])->name('reports.advanced');
