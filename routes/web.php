...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/matches/{match}/live', [\App\Http\Controllers\MatchShowController::class, 'show'])->name('matches.live');
    ...
    Route::get('/reports/advanced', [\App\Http\Controllers\AdvancedReportController::class, 'index'])->name('reports.advanced');
