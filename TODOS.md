...
- [ ] Tambah search, filter, pagination dan empty/error states yang konsisten pada halaman admin utama. Participants, Events, Matches dan Results kini ada carian server-side serta empty state/filter controls; pagination khusus Matches/Results dan halaman admin lain masih perlu diselaraskan.
