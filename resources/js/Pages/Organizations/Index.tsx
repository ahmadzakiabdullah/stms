    ...
    return (
        ...
        >
            ...
            <Dialog open={!!deleteOrg} onOpenChange={(isOpen) => !isOpen && setDeleteOrg(null)}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {t('Are you sure you want to delete')} <strong>{deleteOrg?.name}</strong>? {t('This action cannot be undone.')}
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
            ...
            <div className="mt-6 text-xs text-muted-foreground">
                {t('M1: Organization module with full CRUD. Next: RBAC, User association with organization_id, and scoping.')}
            </div>
        </AuthenticatedLayout>
    );
}
