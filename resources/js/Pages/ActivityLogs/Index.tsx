                    ...
                    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                        {isSuperAdmin && (
                            <label className="grid gap-1 text-xs font-medium text-muted-foreground">
                                {t('Organization')}
                                <select aria-label={t('Filter activity by organization')} className="h-9 rounded-md border border-input bg-background px-3 text-sm text-foreground" value={filters.organization_id} onChange={(event) => visit({ organization_id: event.target.value })}>
                        ...
                        <label className="grid gap-1 text-xs font-medium text-muted-foreground">
                            {t('Event')}
                            <select aria-label={t('Filter activity by event')} className="h-9 rounded-md border border-input bg-background px-3 text-sm text-foreground" value={filters.event} onChange={(event) => visit({ event: event.target.value })}>
