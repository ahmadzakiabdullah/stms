                ...
                {(approvedCount > 0 || rejectedCount > 0) && (
                    <Card>
                        <CardHeader className="pb-3">
                            ...
                            <CardDescription>
                                {approvedCount > 0 && <span className="text-emerald-600">{t('{{count}} approved', { count: approvedCount })}</span>}
                                {approvedCount > 0 && rejectedCount > 0 && <span> · </span>}
                                {rejectedCount > 0 && <span className="text-red-600">{t('{{count}} rejected', { count: rejectedCount })}</span>}
