            ...
            <DialogContent className="max-w-lg">
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="grid gap-2">
                            <Label htmlFor="password">{t('Password')} {editingUser && t('(leave blank if not changing)')}</Label>
    ...
    return (
        ...
        >
            ...
            <Dialog open={!!deleteUser} onOpenChange={(isOpen) => !isOpen && setDeleteUser(null)}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {t('Are you sure you want to delete')} <strong>{deleteUser?.name}</strong>? {t('This action cannot be undone.')}
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
            ...
            <Dialog open={!!resetPasswordUser} onOpenChange={(isOpen) => !isOpen && setResetPasswordUser(null)}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {t('Set a new password for')} <strong>{resetPasswordUser?.name}</strong> ({resetPasswordUser?.email})
                        </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                        <div className="grid gap-2">
            ...
            <div className="mt-6 text-xs text-muted-foreground">
                {t('M1: User Management + RBAC. Users can login, create organizations, and assign roles.')}
            </div>
        </AuthenticatedLayout>
    );
}
