                                                            ...
                                                            {sport.categories?.map((cat) => (
                                                                <div key={cat.id} className="flex items-center justify-between rounded border bg-background px-3 py-2 text-sm">
                                                                    ...
                                                                    <div className="space-x-1">
                                                                        <Button variant="ghost" size="sm" onClick={() => openCatEdit(cat)} aria-label="Edit category">
                                                                            <Pencil className="size-3" />
                                                                        </Button>
                                                                        <Button variant="ghost" size="sm" className="text-destructive" onClick={() => setDeleteCat(cat)} aria-label="Delete category">
