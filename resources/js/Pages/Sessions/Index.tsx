    ...
    return (
                    ...
                    <Dialog open={open} onOpenChange={(isOpen) => {
                        ...
                        <DialogContent className="max-w-lg">
                            <form onSubmit={handleSubmit(onSubmit)}>
                                <DialogHeader>
                                    <DialogTitle>{editingSession ? t('Edit Session') : t('Create New Session')}</DialogTitle>
                                    <DialogDescription>
                                ...
                                <DialogFooter>
                                    ...
                                    <Button type="submit" disabled={isSubmitting}>
                                        ...
                                        {editingSession ? t('Update') : t('Save')}
                                    </Button>
                                </DialogFooter>
                            </form>
                        </DialogContent>
        ...
        >
            ...
            <Dialog open={!!deleteSession} onOpenChange={(isOpen) => !isOpen && setDeleteSession(null)}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {t('Are you sure you want to delete')} <strong>{deleteSession?.name}</strong>? {t('This action cannot be undone.')}
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
            ...
            <div className="mt-6 text-xs text-muted-foreground">
                {t('M2: Session Management. Sessions contain tournaments and events. Next: Tournaments.')}
            </div>
        </AuthenticatedLayout>
    );
}
