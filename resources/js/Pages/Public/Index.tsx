        ...
        <PublicLayout title={competition?.name || app_name} appName={app_name} current="home">
            ...
            <main>
                ...
                <section className="border-y border-[var(--public-dark-border)] bg-[var(--public-background)] py-20 sm:py-24"><div className="mx-auto max-w-7xl px-4 sm:px-6">
                    ...
                    <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">{faculties.map(faculty => <Link key={faculty?.name} href={route('public.faculties')} className="group flex flex-col items-center gap-5 rounded-2xl border border-[var(--public-dark-border)] bg-white p-7 text-center transition duration-300 hover:-translate-y-1 hover:border-[var(--public-primary-border)] hover:shadow-[0_24px_70px_-48px_rgba(7,27,51,.9)]"><ParticipantLogo participant={faculty} size="xl" alt="" className="size-24 rounded-2xl border border-[var(--public-dark-border)] bg-white p-3" /><h3 className="text-base font-black leading-snug">{faculty?.name || 'TBC'}</h3></Link>)}</div>
                </div></section>
