        ...
        <PublicLayout title={competition?.name || app_name} appName={app_name} current="home">
            ...
            <main>
                ...
                <section className="border-y border-[var(--public-dark-border)] bg-[var(--public-background)] py-20 sm:py-24"><div className="mx-auto max-w-7xl px-4 sm:px-6">
                    ...
                    <div className="mt-12 grid items-center gap-x-10 gap-y-12 sm:grid-cols-2 lg:grid-cols-4">{faculties.map(faculty => <Link key={faculty?.name} href={route('public.faculties')} className="group flex justify-center transition duration-300 hover:scale-105"><ParticipantLogo participant={faculty} size="xl" alt="" className="size-32" /></Link>)}</div>
                </div></section>
