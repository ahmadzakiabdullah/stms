                            ...
                            {tournaments.map((tournament) => (
                                <TableRow key={tournament.id}>
                                    ...
                                    <TableCell>
                                        ...
                                        >
                                            {tournament.is_active ? t('Active') : t('Inactive')}
                                        </span>
                                    </TableCell>
                                    <TableCell className="text-right space-x-2">
                                        ...
                                        >
                                            ...
                                            {generatingId === tournament.id ? t('Generating...') : t('Gen Events')}
                                        </Button>
                                        <Button
                                            variant="outline"
                                            size="sm"
            ...
            <Dialog open={!!deleteTournament} onOpenChange={(isOpen) => !isOpen && setDeleteTournament(null)}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {t('Are you sure you want to delete')} <strong>{deleteTournament?.name}</strong>? {t('This action cannot be undone.')}
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
...
function TournamentFormDialog({ tournament, sessions, allSports, onClose }: { tournament: TournamentRow | null; sessions: Session[]; allSports: Sport[]; onClose: () => void }) {
    ...
    return (
        <form onSubmit={onSubmit}>
            <DialogHeader>
                <DialogTitle>{tournament ? t('Edit Tournament') : t('Create New Tournament')}</DialogTitle>
                <DialogDescription>
            ...
            <div className="grid gap-4 py-4">
                ...
                <div className="grid gap-2">
                    ...
                    <Input
                        ...
                        placeholder={t('inter-faculty-sports-2026')}
                    />
