                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Manage participant registrations for tournaments
                        </p>
                    </div>
                    ...
                    <Dialog open={open} onOpenChange={(isOpen) => {
                        ...
                        <DialogContent className="max-w-lg">
                            <form onSubmit={handleSubmit(onSubmit)}>
                                <DialogHeader>
                                    <DialogTitle>{editingRegistration ? 'Edit Registration' : 'Register Participant'}</DialogTitle>
                                    <DialogDescription>
                                        Register a participant for a specific tournament.
                                    </DialogDescription>
                                </DialogHeader>
                                ...
                                <div className="grid gap-4 py-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div className="grid gap-2">
                                            <Label htmlFor="registered_at">Registration Date</Label>
                                            <Input
                                                id="registered_at"
                                                type="date"
                                ...
                                <DialogFooter>
                                    ...
                                    <Button type="submit" disabled={isSubmitting}>
                                        ...
                                        {editingRegistration ? 'Update' : 'Save'}
                                    </Button>
                                </DialogFooter>
                            </form>
                        </DialogContent>
        ...
        >
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        All participant registrations across tournaments. Track status from pending to confirmed.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <Table>
