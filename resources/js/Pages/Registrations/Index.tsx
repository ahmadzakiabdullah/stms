        ...
        >
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        {t('All participant registrations across tournaments. Track status from pending to confirmed.')}
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <Table>
            ...
            <Dialog open={!!deleteRegistration} onOpenChange={(isOpen) => !isOpen && setDeleteRegistration(null)}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {t('Are you sure you want to delete this registration? This action cannot be undone.')}
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
            ...
            <div className="mt-6 text-xs text-muted-foreground">
                {t('M3: Registration module complete. Track participant sign-ups for tournaments.')}
            </div>
        </AuthenticatedLayout>
    );
}
