            ...
            <nav className="flex-1 space-y-0 overflow-y-auto px-2 py-2">
                {navSections.map((section, sectionIdx) => {
                    ...
                    return (
                        <div key={sectionIdx}>
                            {section.title && (
                                <div className="px-2 pb-0.5 pt-1 text-xs font-semibold uppercase tracking-[0.5px] text-muted-foreground/70">{t(section.title)}</div>
                            )}
                ...
                <div className="mt-1 border-t border-sidebar-border pt-1">
                    <Link
                        ...
                        as="button"
                        onClick={onNavigate}
                        className="flex min-h-11 w-full items-center gap-3 rounded-lg px-2 py-1 text-sm font-medium text-muted-foreground transition hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"
                    >
