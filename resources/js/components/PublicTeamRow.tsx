...
export default function PublicTeamRow({ team, right = false, surface = 'light', size = 'sm', fallback = '—' }: Props) {
    return (
        <div className={cn('flex min-w-0 items-center gap-2', right && 'justify-end text-right')}>
            <ParticipantLogo participant={team} surface={surface} size={size} alt="" />
