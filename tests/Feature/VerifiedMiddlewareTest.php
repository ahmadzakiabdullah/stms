...
class VerifiedMiddlewareTest extends TestCase
{
    ...
    public function test_unverified_user_redirected_from_sensitive_routes(): void
    {
        $org = Organization::factory()->create();
        $user = $this->createStaffUser($org);
        $user->email_verified_at = null;
    ...
    public function test_unverified_user_redirected_from_matches(): void
    {
        $org = Organization::factory()->create();
        $user = $this->createStaffUser($org);
        $user->email_verified_at = null;
    ...
    public function test_unverified_user_redirected_from_results(): void
    {
        $org = Organization::factory()->create();
        $user = $this->createStaffUser($org);
        $user->email_verified_at = null;
    ...
    public function test_unverified_user_redirected_from_rankings(): void
    {
        $org = Organization::factory()->create();
        $user = $this->createStaffUser($org);
        $user->email_verified_at = null;
