...
> **Addendum 18 Ogos 2026:** Connected CI #106 lulus pada `a8df4dd`, termasuk perubahan contact settings, dan artifact PCOV merekod 74.99% statement coverage (4,551/6,069). Working tree susulan mengekstrak query orchestration Dashboard/Event/Event Participant kepada service khusus, menambah ratchet coverage 74.5%, menyusun semula release blockers serta menyediakan preflight/evidence template. Semua gate tempatan perlu dijalankan semula dan connected CI baharu mesti lulus pada commit hasil kerja ini sebelum ia boleh menggantikan baseline #106. Production kekal NO-GO sehingga bukti operator dalam `TODOS.md` lengkap.
